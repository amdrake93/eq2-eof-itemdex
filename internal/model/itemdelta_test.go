...
func TestItemDeltaInteractionMultiplicative(t *testing.T) {
	...
	low := ItemDelta(StatBlock{}, main, off, arts, flurry, nil, 1.0, 600)
	high := ItemDelta(StatBlock{DPSMod: 200}, main, off, arts, flurry, nil, 1.0, 600)
...
func TestItemDeltaCappedStatZero(t *testing.T) {
	...
	off := Weapon{AvgDamage: 158, DelaySecs: 4.4}
	var arts []spell.CombatArt
	d := ItemDelta(StatBlock{Haste: 300}, main, off, arts, StatBlock{Haste: 50}, nil, 1.0, 600)
...
func TestItemDeltaOffHandWeapon(t *testing.T) {
	...
	d := ItemDelta(StatBlock{}, main, Weapon{}, arts, StatBlock{}, &w, 1.0, 600)
